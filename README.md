...
## Algorithm
Load the Data Import the dataset to begin the dimensionality reduction process.

Explore the Data Perform an initial analysis to understand data characteristics, distributions, and potential patterns.
...
Apply PCA for Dimensionality Reduction Use PCA to reduce the dataset’s dimensionality while retaining the most significant features.

Analyze Explained Variance Assess the variance explained by each principal component to determine the effectiveness of dimensionality reduction.

Visualize Principal Components Create visualizations of the principal components to interpret patterns and clusters in reduced dimensions.
...
## Output:
<img width="701" height="671" alt="image" src="https://github.com/user-attachments/assets/d77542cb-55d9-4ed1-82ce-8cb64ac0768a" />
